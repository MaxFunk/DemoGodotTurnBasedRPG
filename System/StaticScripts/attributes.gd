...
static func get_attribute_icon(id: int) -> CompressedTexture2D:
	match id:
		...
		NATURE: return preload("res://Resources/Images/AttributeIcons/attribute_icon_7_nature.png")
		...
		WATER: return preload("res://Resources/Images/AttributeIcons/attribute_icon_10_water.png");
